"""Qdrant-based vector store implementation (local embedded mode)."""
...
class QdrantStore(VectorStore):
    """Qdrant local embedded mode store.

    save()/load() are no-ops — Qdrant auto-persists.
    """

    # Deterministic UUID5 from chunk_id — Qdrant requires UUID or int point IDs.
